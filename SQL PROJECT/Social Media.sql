...
-- QUESTION 4: How does caption length distribute across different content types, and are certain formats consistently more text-heavy than others?
...
-- 2. How many posts have been created?
SELECT COUNT(*) AS total_posts
FROM fact_post_creation;

-- 3. How many different hashtags are available?
